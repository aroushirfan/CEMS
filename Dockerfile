...
CMD ["java", "--module-path", "/opt/openjfx/lib", "--add-modules", "javafx.controls,javafx.fxml", "-jar", "./frontend/target/frontend.jar"]
#CMD ["java", "-jar", "./frontend/target/frontend.jar"]