...
class EventControllerTest {
    ...
    // ✅ MUST-DO: Mock mail sender to prevent real email sending
    ...
    void testContext() {
        ...
        for (int i = 0; i < 10; i++) {
            EventDto.EventRequestDTO eventRequestDTO =
                    new EventDto.EventRequestDTO(
                            "test" + i,
                            "description" + i,
                            "location" + i,
                            (long) i,
    ...
    void updateNonExistingEvent() {
        ...
        assertEquals(HttpStatus.NOT_FOUND, ex.getStatusCode()); // <-- correct method
