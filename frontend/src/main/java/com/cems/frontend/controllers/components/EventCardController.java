...
/**
 * Controller for the EventCard component, which displays event details and
 * allows users to register or cancel registration.
 */
...
public class EventCardController {
  ...
  /**
   * Initializes the controller by loading the appropriate resource bundle for
   * localization and setting the text for the "Learn More" button.
   */
  @FXML
  ...
  /**
   * Sets the event model for the card and binds the UI components to the event's properties.
   * It also checks if the user is registered for the event and updates the registration
   * button accordingly.
   *
