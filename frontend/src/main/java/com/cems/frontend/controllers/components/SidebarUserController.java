...
//        Platform.runLater(() -> {
//
//            if (path.equals(Paths.USER_SETTINGS)) {
//                clearSelected();
...
public class SidebarUserController implements NavigationObserver {
    ...
    @Override
    public void setPage(Paths path) {
        Platform.runLater(() -> {
            clearSelected();
            ...
            if (path.equals(Paths.USER_SETTINGS)) {
                ...
                homeButton.getStyleClass().add("select");
                currentHighlighted = homeButton;
            } else if (path.equals(Paths.CREATE_EVENT)) {
                createEventBtn.getStyleClass().removeAll("regular");
                createEventBtn.getStyleClass().add("select");
                currentHighlighted = createEventBtn;
            }
        });
    }
}
