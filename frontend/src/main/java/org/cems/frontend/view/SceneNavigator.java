package org.cems.frontend.view;
...
public class SceneNavigator {
    ...
    public static void loadPage(String fxmlPath) {
        try {
            ...
            URL resource = SceneNavigator.class.getResource("/org/cems/frontend/view/pages/" + fxmlPath);

            // 2. Safety check: prevent "Location is not set" error
            if (resource == null) {
                System.err.println("Error: Could not find FXML file at: /org/cems/frontend/view/pages/" + fxmlPath);
                return;
            }
